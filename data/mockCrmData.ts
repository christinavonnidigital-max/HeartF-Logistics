...
export const mockOpportunities: Opportunity[] = [
  ...
  {
    id: 5,
    opportunity_name: 'Mining Corp Logistics Contract',
    customer_id: 102,
    ...
    currency: Currency.USD,
    probability: 100,
    expected_close_date: '2024-07-22',
    assigned_to: 2,
    description: 'Annual contract for all transport between Gweru and Durban.',
    next_step: '',
  ...
  {
    id: 6,
    opportunity_name: 'Small Retailer Delivery Trial',
    lead_id: 5, // assume new lead
    ...
    assigned_to: 1,
    description: 'Trial for 1 month of local deliveries.',
    next_step: '',
    lost_reason: 'Chose competitor based on price.',
