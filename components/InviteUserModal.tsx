...
const InviteUserModal: React.FC<InviteUserModalProps> = ({ onClose, onInvite }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-100 flex justify-center md:pl-64 items-center p-4 animate-in fade-in duration-200" onClick={onClose}>
