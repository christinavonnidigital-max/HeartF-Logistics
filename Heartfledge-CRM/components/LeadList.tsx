...
import { PlusIcon, UploadIcon, TrashIcon, SearchIcon, SparklesIcon } from './icons/Icons';
...
interface LeadListProps {
  ...
  onProspectClick: () => void;
}

const LeadList: React.FC<LeadListProps> = ({ leads, onSelectLead, onAddLeadClick, onImportClick, onDeleteLead, onProspectClick }) => {
          ...
          actions={
            <>
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-orange-100 px-3 py-2 text-xs font-semibold text-orange-700 shadow-sm hover:bg-orange-200 transition"
              >
                <SparklesIcon className="w-4 h-4" />
                <span>Prospect on Web</span>
              </button>
              <button
